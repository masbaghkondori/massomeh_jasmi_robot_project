...
create_new_bedroom
 ...
 perform_edit_bedroom
    input text                                          ${bedroom_pg_price_field}                               ${bedroom_pg_new_price}                                                
    click Element                                       ${bedroom_pg_status_submenue}             
    click Element                                       ${bedroom_pg_status_option} 
    click Element                                       ${bedroom_pg_element_on_the_edit_save}
